...
void WindowFrame::create(WideString text, uint32 style, uint32 exStyle)
{
  Window::create(0, 0, 10, 10, text, style, exStyle, ownerWindow);
}
void WindowFrame::create(WideString wndClass, WideString text, uint32 style, uint32 exStyle)
{
